...
def llhCPP(theta):
    ...
    output=lvsearch.llhFull(np.array(t))
    # print 'params ', theta
    # print 'llh    ', -output
    return -output
...
def lnprior(theta):
    ...
    if 0 < normalization < 5 and -1 < cosmic_ray_slope < 1 and \
...
np.save("chain_full_nolv_noastro",samples)
...
fig.savefig("/data/icecube/software/LVTools_package/LVTools/python/triangle_full_nolv_nosatro.png")
print 'DONE!'
