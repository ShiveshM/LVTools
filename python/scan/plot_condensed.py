...
if this == r'a':
    ...
    fig.text(0.001, 0.5, r'${\rm Im}('+this+r'_{\mu\tau})$', va='center', rotation='vertical')
elif this == r'c':
    ...
    fig.text(0.5, 0.01, r'${\rm Re}('+this+r'_{\mu\tau})\:({\rm GeV}^2)$', ha='center')
    fig.text(0.001, 0.5, r'${\rm Im}('+this+r'_{\mu\tau})\:({\rm GeV}^2)$', va='center', rotation='vertical')
if this == r'a':
